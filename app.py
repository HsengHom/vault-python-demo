...
def fetch_secret():
    """Connects to Vault using token auth and reads KV v2 secret."""
...
def render_template(title: str, vault_url: str, secret_path: str, username: str, password: str) -> str:
    """Reads templates/index.html and injects secret values. Reusable across apps."""
    ...
    def do_GET(self):
        try:
            ...
            html_content = render_template(
                title="Vault Secret with Direct Token Auth",
